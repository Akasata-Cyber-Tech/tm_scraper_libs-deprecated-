...
# from utils.selenium.web_driver import *
# from utils.selenium.get_session import *
# from utils.suspicious_object_batchAdd import *
from utils.data_parser import fieldList
# import modules.dataGroups as dataGroups
# from utils.monitors.monitoring_authLogin import *
# from utils.generator.generate_text_report import *
# from utils.generator.generate_csv import *
# from utils.scraper.suspicious_object_list_scraper import suspicious_object_collector
# from utils.observedMonitoring import observedMonitoring
...
import pickle
from modules.exportData import export_json_search
from modules.exportData import export_json_data_groups
...
def seach_query(token: str, keyword: str, type:str):
    ...
    now = datetime.now()
    to_timestamp = now.timestamp()
    from_timestamp = to_timestamp - (240)
