...
CSV_DATA_PATH = os.path.join(BASE_PATH, 'csv_data_path')
SUPABASE_DATA_PATH = os.path.join(BASE_PATH, 'supabase_data')
MONITORING_DATA_PATH = os.path.join(BASE_PATH, 'monitoring_data')
