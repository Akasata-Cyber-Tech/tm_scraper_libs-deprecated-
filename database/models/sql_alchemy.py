...
db_url = 'postgresql://tefos:TeFoS_S3CURE$$@10.147.17.166:5432'  # Change this to your PostgreSQL connection string
...
new_user = User(name='tfs', email='tegarfirman@example.com')
